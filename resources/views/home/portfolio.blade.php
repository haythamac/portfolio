    ...
    <div class="grid grid-cols-2">
        @foreach ($projects as $project)
            <div x-data="{ isOpen: false }">
                <div @click="isOpen = true"
                    class="cursor-pointer relative group max-w-md mb-16 overflow-hidden bg-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-transform duration-300 transform hover:scale-105">
                    <!-- Background Image -->
                    <div class="bg-cover bg-center h-48 transition-transform duration-300 transform hover:scale-110"
                        style="background-image: url('/project-images/{{ $project->image }}')"></div>

                    <!-- Overlay Content -->
                    <div
                        class="absolute inset-0 bg-black bg-opacity-50 flex items-end transition-opacity duration-300 opacity-0 group-hover:opacity-100">
                        <div class="p-4">
        ...
        <div x-data="{ isOpen: false }">
            <div @click="isOpen = true"
                ...
                <!-- Background Image -->
                <div class="bg-contain bg-no-repeat bg-center h-16 translate-y-full transition-transform duration-300 transform hover:scale-110"
                    style="background-image: url('/images/plus2.png')"></div>
